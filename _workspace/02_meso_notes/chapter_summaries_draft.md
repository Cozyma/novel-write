...
chapter_acts:
  ...
  act3_climax:
    ...
    cliffhanger: "現状の戦力では到底太刀打ちできない戦力差の中、ボスが証拠隠滅（スラムの口封じ）に動き出す。今夜突入しなければ手遅れになるタイムリミット（危機）が発生して引く。"

scenes:
  - scene_01: "アジトへの潜入準備"
  - scene_02: "ボスの正体とタイムリミットの発生"
...
chapter_acts:
  act1_intro:
    hook: "タイムリミットが迫る中、マーレンは「自身の封印を解けばシステム加護ごと粉砕できる」という過信から密造工房への強襲を決行する。"
  act2_conflict:
